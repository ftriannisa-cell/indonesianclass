        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, rgba(255,234,167,0.95) 0%, rgba(250,177,160,0.95) 100%),
                        url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800"><defs><pattern id="batik" patternUnits="userSpaceOnUse" width="100" height="100"><circle cx="25" cy="25" r="3" fill="%23d35400" opacity="0.1"/><circle cx="75" cy="75" r="3" fill="%23d35400" opacity="0.1"/><path d="M 25 50 Q 50 25 75 50 Q 50 75 25 50" fill="none" stroke="%23d35400" stroke-width="0.5" opacity="0.15"/></pattern></defs><rect width="1200" height="800" fill="url(%23batik)"/><g opacity="0.15"><path d="M 100,300 Q 150,250 200,300 T 300,300" fill="none" stroke="%23e74c3c" stroke-width="2"/><circle cx="400" cy="200" r="40" fill="%23f39c12" opacity="0.3"/><path d="M 600,400 L 650,350 L 700,400 Z" fill="%2327ae60" opacity="0.3"/><circle cx="800" cy="500" r="25" fill="%23e74c3c" opacity="0.3"/><path d="M 200,600 Q 250,550 300,600 L 280,650 L 220,650 Z" fill="%23d35400" opacity="0.25"/><circle cx="900" cy="300" r="30" fill="%23f39c12" opacity="0.3"/><path d="M 150,150 L 180,120 L 210,150 L 180,180 Z" fill="%23c0392b" opacity="0.3"/></g></svg>');
        ...
        .header {
            background: linear-gradient(135deg, rgba(253,203,110,0.95) 0%, rgba(250,177,160,0.95) 100%),
                        url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><radialGradient id="templeGrad"><stop offset="0%25" stop-color="%23d35400" stop-opacity="0.2"/><stop offset="100%25" stop-color="%23d35400" stop-opacity="0"/></radialGradient></defs><g opacity="0.2"><path d="M 100,200 L 150,150 L 200,200 L 190,250 L 160,250 L 160,280 L 140,280 L 140,250 L 110,250 Z" fill="%23c0392b"/><circle cx="500" cy="180" r="60" fill="url(%23templeGrad)"/><path d="M 650,220 Q 680,180 710,220 L 700,260 L 660,260 Z" fill="%23e74c3c" opacity="0.6"/><rect x="300" y="240" width="80" height="40" rx="5" fill="%23f39c12" opacity="0.5"/></g></svg>');
            background-size: cover;
            color: #2d3436;
            padding: 60px 40px;
            text-align: center;
            ...
            <div class="section">
                ...
                <div class="why-choose">
                    ...
                    <div class="feature">
                        ...
                        Official Spanish certification + Professional interpreter experience<br>
                        <em style="font-size: 0.9em; margin-top: 5px; display: block;">"Cuento con la certificación DELE B2 del Instituto Cervantes, obtenida en 2024."</em>
                    </div>
                    <div class="feature">
                        <strong>🇮🇩 Native Speaker</strong>
                        Born and raised in Indonesia with 5+ years teaching experience
                    </div>
                    <div class="feature">
                        <strong>💬 Teach in English or Spanish</strong>
                        Crystal-clear explanations in your preferred language<br>
                        <em style="font-size: 0.9em; margin-top: 5px; display: block;">"Explicaciones clarísimas en tu idioma favorito: ¡puedo enseñarte en español de España o de Latinoamérica!"</em>
                    </div>
                    <div class="feature">
            ...
            <div class="section">
                ...
                <div class="perfect-for">
                    <div class="target-card">
                        ...
                        <p style="margin-top: 5px; font-size: 0.9em;"><em>"¡Claro que sí! Por supuesto que también puedo enseñarte indonesio en español."</em></p>
                    </div>
                    <div class="target-card">
                        <span class="emoji">🇺🇸</span>
            ...
            <div class="section">
                ...
                <div style="background: linear-gradient(135d, #a29bfe 0%, #ffeaa7 100%); color: #2d3436; padding: 30px; border-radius: 15px; margin-top: 20px;">
                    <ul style="list-style: none; padding: 0;">
                        ...
                        <li style="padding: 10px 0; border-bottom: 1px solid rgba(45,52,54,0.1);">✨ Order food like a local (no more pointing at menus!)<br><em style="font-size: 0.9em; margin-top: 3px; display: block;">"Pide tu comida con total seguridad."</em></li>
            ...
            <div class="section">
                ...
                <div class="about-teacher">
                    <p style="font-size: 1.1em; margin-bottom: 15px;">
                        Hi! I'm <strong>Annisa</strong>, a <strong>professional interpreter</strong> working with Indonesian, English, and Spanish daily. I've been teaching languages for over 5 years and hold an official <strong>DELE certificate</strong> in Spanish.
                    </p>
